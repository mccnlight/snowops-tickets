...
type TicketAssignment struct {
	...
	TripStartedAt    *time.Time       `gorm:"type:timestamptz" json:"trip_started_at,omitempty"`
	TripFinishedAt   *time.Time       `gorm:"type:timestamptz" json:"trip_finished_at,omitempty"`
